...
function draw4()
{
   canvas4=document.getElementById('detection_canvas');
    if (canvas4.getContext)
    {
        ...
        LineGraph_SetLegendText(pindex2,1,"y");
        LineGraph_SetLegendText(pindex2,2,"z");
        LineGraph_SetLegendText(pindex3,0,"yaw");
        LineGraph_SetLegendText(pindex3,1,"pitch");
        LineGraph_SetLegendText(pindex3,2,"roll");
        LineGraph_SetLegendText(pindex4,0," ");
        LineGraph_SetLegendText(pindex4,1," ");
        LineGraph_SetLegendText(pindex4,2," ");
        ...
        // peter LineGraph_SetRange(pindex2,0,-32768,32768);
        //LineGraph_SetRange(pindex2,1,-32768,32768);
        //LineGraph_SetRange(pindex2,2,-32768,32768);        
        LineGraph_SetRange(pindex2,0,-2048,2048);
        LineGraph_SetRange(pindex2,1,-2048,2048);
        LineGraph_SetRange(pindex2,2,-2048,2048);
        
        // peter LineGraph_SetRange(pindex1,0,-32768,32768);
        //LineGraph_SetRange(pindex1,1,-32768,32768);
        //LineGraph_SetRange(pindex1,2,-32768,32768);
        LineGraph_SetRange(pindex1,0,-2048,2048);
        LineGraph_SetRange(pindex1,1,-2048,2048);
        LineGraph_SetRange(pindex1,2,-2048,2048);
                
        // peter LineGraph_SetRange(pindex3,0,-32768,32768);
        //LineGraph_SetRange(pindex3,1,-32768,32768);
        //LineGraph_SetRange(pindex3,2,-32768,32768);
        LineGraph_SetRange(pindex3,0,-360,360);
        LineGraph_SetRange(pindex3,1,-360,360);
        LineGraph_SetRange(pindex3,2,-360,360);        
        
        LineGraph_SetRange(pindex4,0,0,250);
        LineGraph_SetRange(pindex4,1,0,250);
        LineGraph_SetRange(pindex4,2,0,250);
