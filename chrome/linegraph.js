...
var default_LineGraph_minvalue=-1024// peter 0;
var default_LineGraph_maxvalue=1024; // peter 65536;
...
{   //LineGraph_AddData -> add data onto the bar graph data array
    ...
    // console.log('LineGraph_AddData LineGraph_minvalue: ' + LineGraph_minvalue[index][varindex] + ' LineGraph_maxvalue: ' + LineGraph_maxvalue[index][varindex] +' LineGraph_NoPoints: ' + LineGraph_NoPoints[index]);
